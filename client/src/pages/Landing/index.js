            ...
            <div className="container">
                <div className="row my-4">
                    ...
                    <div className="col-md-6 align-self-center">
                        <center>
                            <h1>
                                <b>
                                    Meet Edward! The smarter sibling of the{" "}
                                    <a href="https://www.sec.gov/edgar/searchedgar/companysearch.html" target="_blank" style={{ color: "#a873fc" }}>
                                        SEC's Edgar
                                    </a>
                                </b>
                            </h1>
                            <h5>
                                <b>Become a well-informed investor!</b>
                            </h5>
                            <a className="btn text-light" style={{ backgroundColor: "#a873fc" }} href="/signup">
                                Sign Up for Free
                            </a>{" "}
                        </center>
                    </div>
                ...
                <div className="row my-4 justify-content-md-center">
                    <div className="col-md-8 text-center mb-3">
                        <b>
                            <h2>What Edward Can Do For You</h2>
                        </b>
                ...
                <div className="row card-deck my-4 justify-content-md-center">
                    <div className="card col-md-3 mx-5 border-0">
                        ...
                        <div className="card-body">
                            <center>
                                <h6 className="card-title">Key Performance Indicators</h6>
                            </center>
                    ...
                    <div className="card col-md-3 mx-5 border-0">
                        ...
                        <div className="card-body">
                            <center>
                                <h6 className="card-title">Insider Transactions</h6>
                            </center>
                        </div>
                    </div>
                    <div className="card col-md-3 mx-5 border-0">
                        ...
                        <div className="card-body">
                            <center>
                                <h6 className="card-title">Financial Statement Key Textual Information</h6>
                            </center>
                        </div>
                    </div>
                </div>
